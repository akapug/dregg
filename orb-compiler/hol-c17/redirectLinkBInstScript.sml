(* ===========================================================================
   ...
   emitted redirectstatus program against the REAL, built CakeML backend
   ...
   TCB: redirectStatusProg is the VERIFIED parser's output.
   =========================================================================== *)
...
val _ = new_theory "redirectLinkBInst";

val linkB_result =
  mk_linkB { pnkFile = "redirectstatus.pnk", progName = "redirectStatusProg" };

val redirectStatusProg_is_parser_output = #parser_output linkB_result;
val redirectStatusProg_linkB            = #linkB linkB_result;

val _ = save_thm ("redirectStatusProg_is_parser_output", redirectStatusProg_is_parser_output);
val _ = save_thm ("redirectStatusProg_linkB", redirectStatusProg_linkB);
