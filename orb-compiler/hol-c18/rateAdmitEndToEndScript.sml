(* ===========================================================================
   ...
   rateAdmitProg_semantics_decls (whole-program Link A) with
   rateAdmitProg_linkB (Link B backend) into ONE kernel-checked theorem: every
   ...
   Lean spec `C15.rateAdmit` value `n2w (rateAdmit code)`.  The install-
   package hypotheses are taken VERBATIM from rateAdmitProg_linkB; the only
   extra hypothesis is the single FFI-oracle contract `rateAdmitFFI`.
   =========================================================================== *)
open HolKernel boolLib bossLib Parse;
open arithmeticTheory listTheory wordsTheory finite_mapTheory optionTheory;
open panLangTheory panSemTheory;
open rateAdmitLinkBInstTheory;    (* rateAdmitProg, rateAdmitProg_linkB *)
open rateAdmitCoreTheory;         (* rateAdmit *)
open rateAdmitWrapperTheory;      (* rateAdmitFFI *)
open rateAdmitInstallTheory;      (* rateAdmitProg_semantics_decls *)

val _ = new_theory "rateAdmitEndToEnd";

val linkB_ant    = rateAdmitProg_linkB |> concl |> dest_imp |> #1;
val linkB_concl  = rateAdmitProg_linkB |> concl |> dest_imp |> #2;
