(* ===========================================================================
   C14 probe, PART 0 — the PROGRAM-AGNOSTIC descent machinery.

   These lemmas are byte-identical to the generic (non-boundScan) lemmas of
   C13's boundScanWrapperLinkAScript + semLiftScript.  They are RE-DECLARED here
   (rather than opened) ONLY to sidestep a cross-tree theory-hash clash between
   ~/c2's machineStepLinkA and the machineStepLinkA that ~/c6work's loop
   machinery was built against — the branch-only primitive needs NONE of the
   loop machinery.  Every theorem below is program-agnostic and reusable for
   ANY straight-line/branch Pancake program with the load_vec/report_vec FFI
   shape.  (Reusability evidence: this whole file is the C13 generic core,
   unchanged.)
   =========================================================================== *)
