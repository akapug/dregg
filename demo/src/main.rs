...
impl DemoState {
    ...
    fn step_2_mint_token(&self) -> token::TokenState {
        ...
        println!("                 app(\"admin-panel\", \"r\"), app(\"docs\", \"rw\"),");
        println!("                 service(\"http\", \"rw\"), service(\"grpc\", \"rw\"),");
        println!("                 service(\"dns\", \"r\"), service(\"metrics\", \"r\")");
        println!(
            "  {} State root (BLAKE3): {}",
            arrow(),
    ...
    fn step_3_attenuate(&self, root_token: &token::TokenState) -> (token::TokenState, FoldDelta) {
        ...
        println!("              app(\"docs\", \"rw\"), service(\"grpc\", \"rw\"),");
        println!("              service(\"dns\", \"r\"), service(\"metrics\", \"r\")");
        println!(
