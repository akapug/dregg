//! Runtime types for dregg-dsl generated code.
//!
...
// Re-export all DSL modules from dregg-circuit.
pub use dregg_circuit::dsl::accumulator;
pub use dregg_circuit::dsl::circuit;
pub use dregg_circuit::dsl::derivation;
pub use dregg_circuit::dsl::descriptors;
...
// beyond what dregg_circuit::dsl already provides).
pub mod composition;
...
/// Descriptor for an AIR constraint set generated from a dregg caveat or effect.
///
...
/// Descriptor for a dregg effect (constraint with state mutation).
#[derive(Debug, Clone)]
