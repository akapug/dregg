...
use dregg_circuit::plonky3_prover::{DreggProof, create_config, to_p3};
...
fn serialize_dsl_p3_proof(proof: &DreggProof) -> Result<Vec<u8>, String> {
...
fn deserialize_dsl_p3_proof(bytes: &[u8]) -> Result<DreggProof, String> {
    if bytes.len() < 4 {
