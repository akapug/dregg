//! Witness-generation and algebraic verification primitives for the dregg-dsl
//! differential testing infrastructure.
//!
//! The differential test (`02-testing.md` section 2) emits, for each
//! `#[dregg_caveat]`, a `proptest!` test that asserts the Rust evaluator
...
/// macro-emitted `__dregg_diff_to_value(&expr)` shim can accept either.
