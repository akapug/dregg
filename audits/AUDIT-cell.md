...
- `cell.rs:240`: domain-separated as `dregg-cell-state-v1`, but the field selection diverges from `ledger.rs:815` (`dregg-cell:merkle-leaf v2`). The v1/v2 naming is inconsistent and the diverging field sets are likely to cause future bugs.
