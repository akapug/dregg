...
// --- Ontology browser (generated effect catalog, anti-drift) ---------------
// <dregg-ontology> teaches all FullActionA effect variants from
// ontology-catalog.generated.json (generated by site/tools/gen-ontology-catalog.js
// from the verified Lean source). The missing authoritative teaching surface.
import './inspectors/ontology.js';

// <dregg-predicate-explorer> teaches the cell-program / predicate language
// (StateConstraint vocabulary + CellProgram kinds + TransitionGuards) from
// predicate-catalog.generated.json (same generator, from cell/src/program.rs)
...
// <dregg-factory-composer> — FACTORY AUTHORING v0: compose a FactoryDescriptor's
// perpetual StateConstraints from the generated predicate catalog, with LIVE
// proof badges driven by assurance-catalog.generated.json (parsed from
// Dregg2/AssuranceCase.lean — every pin #assert_axioms/collectAxioms-certified)
// and worked examples generated by running the real Rust constructors
// (factory-samples.generated.json). Exports the exact serde JSON shape that
// deploy_factory_descriptor accepts.
import './inspectors/factory-composer.js';

// <dregg-cell-history> — RECEIPT TIME-TRAVEL: walk a cell's receipt chain
