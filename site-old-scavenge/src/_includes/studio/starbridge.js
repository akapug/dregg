...
const FALLBACK_APPS = {
  ...
  'compartment-workflow-mandate': {
    ...
    inspectors: ['dregg-cwm-mandate', 'dregg-cwm-advance-form'],
    turn_builders: ['advance_step', 'init_mandate'],
    required_apis: ['signTurn', 'blake3', 'cell.readField', 'builders.compartmentWorkflowMandate'],
  },
  'storage-gateway-mandate': {
    ...
    inspectors: ['dregg-sgm-gateway', 'dregg-sgm-storage-form'],
    turn_builders: ['storage_get', 'storage_put', 'storage_list', 'init_gateway'],
    required_apis: ['signTurn', 'blake3', 'cell.readField', 'builders.storageGatewayMandate'],
  },
  'bounty-board': {
    id: 'bounty-board',
    name: 'Bounty Board',
    ...
    legacy_listen: 'bounty-board:3030',
    caddy_prefix: '/bounty',
    listen_port: 3030,
    page: null,
  },
  ...
  'privacy-voting': {
    ...
    legacy_listen: 'privacy-voting:3100',
    caddy_prefix: '/voting',
    listen_port: 3100,
    page: null,
  },
  'compute-exchange': {
    ...
    legacy_listen: 'compute-exchange:3040',
