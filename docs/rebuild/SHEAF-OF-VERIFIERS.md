...
| Verify (not find) is the adjoint side = verifier-as-TCB | **REAL** | `predicate_witness_galois` `Laws.lean:101`. `find`/`search_sound` is a by-design open-hole contract (`:60`), correctly fenced. |
