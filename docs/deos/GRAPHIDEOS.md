...
4. **Take SystemUI + the permission model** — status bar, quick settings, the
   ...
   held caps as a lit/dim cap-badge set and models a permission grant as a
   receipted hand-over turn — the runtime dialog reforged; SystemUI chrome remains
   the cockpit work in `starbridge-v2`.)*
