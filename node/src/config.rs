//! Operator-side configuration for a pyana-node deployment.
//!
//! # Receipts as persistence — `RetentionPolicy`
//!
//! The houyhnhnm comparison (`HOUYHNHNM-COMPARISON.md` §5.1, §8.1) names a
//! discipline pyana implicitly assumed but never declared: a federation
...
//!
//! Pyana's receipt chain is *the* canonical persistence stream
...
//! storage attested by [`pyana_cell::lifecycle::ArchivalAttestation`] —
...
//!
//! The wire-level shape is [`pyana_wire::message::WireMessage::RequestReceipt`]
//! / [`pyana_wire::message::WireMessage::ReceiptResponse`].
//!
//! ## Default is `Forever`
//!
...
/// [`pyana_cell::lifecycle::ArchivalAttestation`] (or equivalent
...
pub enum RetentionPolicy {
    ...
    /// [`pyana_wire::message::ReceiptUnavailable::CoveredByAttestedRoot`].
    RollingWindow {
    ...
    /// [`pyana_cell::lifecycle::ArchivalAttestation`] whose
...
impl RetentionPolicy {
    ...
    /// return [`pyana_wire::message::WireMessage::ReceiptResponse`]
    /// with [`pyana_wire::message::ReceiptUnavailable::CoveredByAttestedRoot`]
