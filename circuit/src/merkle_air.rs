...
impl core::fmt::Display for MembershipP3Error {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        match self {
            MembershipP3Error::InvalidWitness(r) => write!(f, "invalid membership witness: {r}"),
...
mod tests {
    ...
    fn membership_p3_proves_and_verifies_honest() {
        ...
        let (_dsl_trace, dsl_pis) =
            crate::dsl::membership::generate_merkle_poseidon2_trace(leaf, &siblings, &positions);
