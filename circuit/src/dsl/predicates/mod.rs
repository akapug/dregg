...
pub use base::{
    PredicateOp, PredicateProof, PredicateWitness, compute_blinded_fact_commitment,
    compute_fact_commitment, generate_in_range_traces, generate_predicate_trace,
    generate_predicate_trace_full, predicate_descriptor, prove_predicate_dsl,
    verify_predicate_dsl,
};

pub use relational::{
    RelationalOp, RelationalProof, RelationalWitness,
    compute_commitment as compute_value_commitment, generate_relational_trace,
    generate_relational_trace_full, prove_relational_dsl, relational_predicate_descriptor,
    verify_relational_dsl,
};

pub use arithmetic::{
    ArithExpr, ArithPredicate, ArithmeticPredicateProof, CompareOp, CompiledArith,
    build_arithmetic_predicate_descriptor, compile_expression, evaluate_compiled_slots,
    generate_full_trace as generate_arithmetic_trace, prove_arithmetic_dsl,
    verify_arithmetic_dsl,
};

pub use compound::{
    BooleanFormula, CompoundOp, CompoundPredicateProof, Gate,
    ...
    generate_threshold_trace, prove_compound_dsl, verify_compound_dsl,
};
