...
fn v3_coverage_ledger() -> Vec<(&'static str, Cov)> {
    ...
    vec![
        ...
        ("transferVmDescriptor2R24", Covered("effect_vm_rotation_flip::rotated_transfer_proves_verifies_differential_and_refuses_ghost + vk_epoch_value")),
        ("burnVmDescriptor2R24", Covered("effect_vm_rotation_flip::rotated_burn_cohort_member_proves_verifies + vk_epoch_value")),
        ("mintVmDescriptor2R24", Covered("effect_vm_rotation_flip (mint) + vk_epoch_value")),
        ("supplyMintVmDescriptor2R24", Covered("effect_vm_rotation_flip::rotated_supply_mint_self_verifies_under_dedicated_selector")),
        ("transferFeeVmDescriptor2R24", Covered("effect_vm_rotation_flip")),
        ("incrementNonceVmDescriptor2R24", Covered("vk_epoch_value")),
        ("settleEscrowSatVmDescriptor2R24", Covered("settle_escrow_weld_prove")),
        // ── notes grow-gate — COVERED
        ("noteSpendVmDescriptor2R24", Covered("effect_vm_rotation_flip::rotated_note_spend_pins_nullifier + vk_epoch_notes")),
        ("noteCreateVmDescriptor2R24", Covered("vk_epoch_notes")),
        // ── birth grow-gate — COVERED
        ("createCellVmDescriptor2R24", Covered("effect_vm_rotation_flip::rotated_create_cell_pins_accounts + vk_epoch_birth")),
        ...
        ("refusalVmDescriptor2R24", Covered("vk_epoch_refusal_lifecycle")),
        ("cellSealVmDescriptor2R24", Covered("vk_epoch_refusal_lifecycle")),
        ("makeSovereignVmDescriptor2R24", Covered("vk_epoch_misc (makeSovereign forced-on-wire)")),
        ("receiptArchiveVmDescriptor2R24", Covered("effect_vm_rotation_flip")),
        // ── passthrough / misc — COVERED
        ("emitEventVmDescriptor2R24", Covered("vk_epoch_misc::no_cell_write_audit")),
        ("pipelinedSendVmDescriptor2R24", Covered("vk_epoch_misc::no_cell_write_audit")),
        ("exerciseVmDescriptor2R24", Covered("vk_epoch_misc::no_cell_write_audit")),
        ("setFieldDynVmDescriptor2R24", Covered("vk_epoch_misc (setFieldDyn dynamic overflow write proves)")),
        // ── the turn-bound cap-open transfer — COVERED (the ONLY green cap-open prove-through)
        ("transferCapOpenTBVmDescriptor2R24", Covered("cap_open_turn_bound_verify")),
        // ── LIVE R3 PROBES — this file (cellUnseal/cellDestroy had ZERO roundtrip before)
        ("cellUnsealVmDescriptor2R24", Covered("producer_descriptor_coverage_gate::cell_unseal_v3_producer_descriptor_roundtrip (THIS file — R3 probe)")),
        ("cellDestroyVmDescriptor2R24", Covered("producer_descriptor_coverage_gate::cell_destroy_v3_producer_descriptor_roundtrip (THIS file — R3 probe)")),
        ...
        ("setFieldVmDescriptor2-0R24", Partial("v13 setField written-slot value8 completion seam (vk_epoch_value #[ignore])")),
        ("setFieldVmDescriptor2-1R24", Partial("v13 setField value8 seam")),
        ("setFieldVmDescriptor2-2R24", Partial("v13 setField value8 seam")),
        ("setFieldVmDescriptor2-3R24", Partial("v13 setField value8 seam")),
        ("setFieldVmDescriptor2-4R24", Partial("v13 setField value8 seam")),
        ("setFieldVmDescriptor2-5R24", Partial("v13 setField value8 seam")),
        ("setFieldVmDescriptor2-6R24", Partial("v13 setField value8 seam")),
        ("setFieldVmDescriptor2-7R24", Partial("v13 setField value8 seam")),
        ...
        ("heapWriteVmDescriptor2R24", Partial("structural-only (heap_write_deployed_root_forced); DISTINCT splice producer, no V3 roundtrip")),
        ...
        ("customVmDescriptor2R24", Partial("proves on WIDE only; V3 proofBind roundtrip gated (custom_binding_* #[ignore])")),
        ...
        ("attenuateVmDescriptor2R24", Uncovered("bare cap-write forbidden; route = attenuateCapOpenEff")),
        ("grantCapVmDescriptor2R24", Uncovered("bare cap-write forbidden; route = grantCapCapOpen")),
        ("revokeVmDescriptor2R24", Uncovered("bare cap-write forbidden; route = revokeCapOpen")),
        ("refreshVmDescriptor2R24", Uncovered("bare cap-write forbidden; route = refreshDelegationCapOpen")),
        ("introduceVmDescriptor2R24", Uncovered("bare cap-write forbidden; route = introduceCapOpen")),
        ("revokeCapabilityVmDescriptor2R24", Uncovered("bare cap-write forbidden; route = revokeCapabilityCapOpen")),
        ...
        ("attenuateCapOpenEffVmDescriptor2R24", Uncovered("cap-open prove-through #[ignore]d (IR-v2 cap-node lookup handoff)")),
        ("exerciseCapOpenVmDescriptor2R24", Uncovered("cap-open prove-through #[ignore]d (IR-v2 cap-node lookup handoff)")),
        ("transferCapOpenEffVmDescriptor2R24", Uncovered("cap-open prove-through #[ignore]d (shared IR-v2 handoff)")),
        ("delegateCapOpenVmDescriptor2R24", Uncovered("cap-open prove-through #[ignore]d (shared IR-v2 handoff)")),
        ("introduceCapOpenVmDescriptor2R24", Uncovered("cap-open prove-through #[ignore]d (shared IR-v2 handoff)")),
        ("grantCapCapOpenVmDescriptor2R24", Uncovered("cap-open prove-through #[ignore]d (shared IR-v2 handoff)")),
        ("revokeCapOpenVmDescriptor2R24", Uncovered("cap-open prove-through #[ignore]d (shared IR-v2 handoff)")),
        ("refreshDelegationCapOpenVmDescriptor2R24", Uncovered("cap-open prove-through #[ignore]d (shared IR-v2 handoff)")),
        ("revokeCapabilityCapOpenVmDescriptor2R24", Uncovered("cap-open prove-through #[ignore]d (shared IR-v2 handoff)")),
        ("spawnCapOpenVmDescriptor2R24", Uncovered("cap-open prove-through #[ignore]d (shared IR-v2 handoff)")),
        ("delegateWriteCapOpenVmDescriptor2R24", Uncovered("cap-open write prove-through #[ignore]d (shared IR-v2 handoff)")),
        ("introduceWriteCapOpenVmDescriptor2R24", Uncovered("cap-open write prove-through #[ignore]d (shared IR-v2 handoff)")),
        ("delegateAttenWriteCapOpenVmDescriptor2R24", Uncovered("cap-open write prove-through #[ignore]d (shared IR-v2 handoff)")),
        ("revokeDelegationWriteCapOpenVmDescriptor2R24", Uncovered("cap-open write prove-through #[ignore]d (shared IR-v2 handoff)")),
        ("revokeCapabilityWriteCapOpenVmDescriptor2R24", Uncovered("cap-open write prove-through #[ignore]d (shared IR-v2 handoff)")),
        ("refreshDelegationWriteCapOpenVmDescriptor2R24", Uncovered("cap-open write prove-through #[ignore]d (shared IR-v2 handoff)")),
        ("spawnWriteCapOpenVmDescriptor2R24", Uncovered("cap-open write prove-through #[ignore]d (shared IR-v2 handoff)")),
    ]
}
...
fn wide_coverage_ledger() -> Vec<(&'static str, Cov)> {
    ...
    vec![
        ...
        ("mintVmDescriptor2R24", Covered("wide_completeness_ledger (bridgeMint/mint)")),
        ("noteSpendVmDescriptor2R24", Covered("effect_vm_wide_roundtrip + wide_completeness_ledger")),
        ("noteCreateVmDescriptor2R24", Covered("effect_vm_wide_roundtrip + wide_completeness_ledger")),
        ...
        ("exerciseVmDescriptor2R24", Covered("wide_completeness_ledger (exerciseViaCapability)")),
        ("pipelinedSendVmDescriptor2R24", Covered(scoreboard)),
        ("refreshVmDescriptor2R24", Covered("wide_completeness_ledger (refreshDelegation)")),
        ("incrementNonceVmDescriptor2R24", Covered(scoreboard)),
        ("revokeVmDescriptor2R24", Covered("wide_completeness_ledger (revokeDelegation)")),
        ("introduceVmDescriptor2R24", Covered(scoreboard)),
        ("customVmDescriptor2R24", Covered("wide_completeness_ledger::custom_proves_on_deployed_wide_path")),
        ("setFieldDynVmDescriptor2R24", Covered("effect_vm_wide_roundtrip + wide_completeness_ledger")),
        ("makeSovereignVmDescriptor2R24", Covered(scoreboard)),
        ("createCellVmDescriptor2R24", Covered("effect_vm_wide_roundtrip + wide_completeness_ledger")),
        ("factoryVmDescriptor2R24", Covered("effect_vm_wide_roundtrip + wide_completeness_ledger")),
        ("spawnVmDescriptor2R24", Covered("effect_vm_wide_roundtrip + wide_completeness_ledger")),
        ...
        ("supplyMintVmDescriptor2R24", Covered("wide_new_members_cover (supplyMint proves + LC verifies)")),
        ...
        ("heapWriteVmDescriptor2R24", Partial("wide_new_members_cover structural pin; no end-to-end wide roundtrip (v13 host-const class)")),
        ("transferCapOpenTBVmDescriptor2R24", Partial("wide_new_members_cover structural pin (16 wide-commit PIs); no wide roundtrip")),
        ...
        ("attenuateVmDescriptor2R24", Uncovered("NAMED cap-open route residual (scoreboard unprovable-on-wide)")),
        ("grantCapVmDescriptor2R24", Uncovered("NAMED cap-open route residual (scoreboard unprovable-on-wide)")),
        ("revokeCapabilityVmDescriptor2R24", Uncovered("NAMED cap-open route residual (scoreboard unprovable-on-wide)")),
        ("delegateCapOpenVmDescriptor2R24", Uncovered("cap-open route; bare wide producer UNSAT")),
        ("introduceCapOpenVmDescriptor2R24", Uncovered("cap-open route; bare wide producer UNSAT")),
        ("grantCapCapOpenVmDescriptor2R24", Uncovered("cap-open route; bare wide producer UNSAT")),
        ("revokeCapOpenVmDescriptor2R24", Uncovered("cap-open route; bare wide producer UNSAT")),
        ("refreshDelegationCapOpenVmDescriptor2R24", Uncovered("cap-open route; bare wide producer UNSAT")),
        ("revokeCapabilityCapOpenVmDescriptor2R24", Uncovered("cap-open route; bare wide producer UNSAT")),
        ("transferCapOpenEffVmDescriptor2R24", Uncovered("cap-open route; bare wide producer UNSAT")),
        ("attenuateCapOpenEffVmDescriptor2R24", Uncovered("cap-open route; bare wide producer UNSAT")),
        ("exerciseCapOpenVmDescriptor2R24", Uncovered("cap-open route; bare wide producer UNSAT")),
        ("spawnCapOpenVmDescriptor2R24", Uncovered("cap-open route; bare wide producer UNSAT")),
        ("spawnWriteCapOpenVmDescriptor2R24", Uncovered("cap-open route; bare wide producer UNSAT")),
        ("delegateWriteCapOpenVmDescriptor2R24", Uncovered("cap-open route; bare wide producer UNSAT")),
        ("introduceWriteCapOpenVmDescriptor2R24", Uncovered("cap-open route; bare wide producer UNSAT")),
        ("delegateAttenWriteCapOpenVmDescriptor2R24", Uncovered("cap-open route; bare wide producer UNSAT")),
        ("revokeDelegationWriteCapOpenVmDescriptor2R24", Uncovered("cap-open route; bare wide producer UNSAT")),
        ("revokeCapabilityWriteCapOpenVmDescriptor2R24", Uncovered("cap-open route; bare wide producer UNSAT")),
        ("refreshDelegationWriteCapOpenVmDescriptor2R24", Uncovered("cap-open route; bare wide producer UNSAT")),
    ]
}
...
fn assert_classified(tsv: &str, ledger: &[(&'static str, Cov)], name: &str) {
    ...
    assert_eq!(keys, ledger_keys, "[{name}] ledger must EXACTLY cover the registry");
    ...
    eprintln!("=== [{name}] producer≡descriptor coverage: {} members ===", ledger.len());
...
fn wide_registry_every_member_classified() {
    assert_classified(WIDE_REGISTRY_STAGED_TSV, &wide_coverage_ledger(), "bare-wide");
}
...
fn prove_verify_v3(name: &str, before: Cell, kernel: dregg_turn::Effect, vm_effect: Effect) {
    ...
    eprintln!("[{name}] R3 PROBE GREEN: producer trace proves + verifies against the committed V3 descriptor.");
}
