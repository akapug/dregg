...
use dregg_dsl_runtime::{KimchiCircuitDescriptor, KimchiGateType};
...
/// sync with the comments in `dregg-dsl/src/gen_kimchi.rs`.
...
fn witness_satisfies(
    req: &Requirement,
    gates: &[dregg_dsl_runtime::KimchiGate],
) -> Result<bool, String> {
    match req {
...
fn eval_generic(gate: &dregg_dsl_runtime::KimchiGate, witness: &[i128]) -> i128 {
