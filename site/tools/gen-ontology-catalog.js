...
// `cover_hits_all_three`, all #assert_axioms-pinned), so a docs page that
...
function buildVerbs() {
  ...
  return {
    ...
    note:
      ...
      'cover_hits_all_three — all #assert_axioms-pinned to the kernel triple). ' +
      'Do not edit by hand — regenerate; a drift check (--check) fails if stale.',
    ...
    completeness_theorems: ['classify_total', 'effect_tag_count', 'cover_hits_all_three'],
  };
}
