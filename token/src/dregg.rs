//! Dregg-specific authorization patterns.
//!
//! Defines the standard fact names, check patterns, and policy templates used
//! across both Macaroon and Biscuit tokens in the Dregg runtime.
//!
...
/// Standard Dregg Datalog fact names.
pub mod facts {
...
/// Standard Dregg Datalog authorizer fact names (ambient facts from the request).
