...
pub fn schnorr_circuit_descriptor() -> CircuitDescriptor {
    ...
    let neg3 = BabyBear::new(pyana_circuit::field::BABYBEAR_P - 3);
...
pub fn generate_schnorr_dsl_trace(
    ...
    use pyana_circuit::schnorr_sig::{schnorr_keygen, schnorr_sign};
...
mod tests {
    ...
    use pyana_circuit::field::BabyBear;
    use pyana_circuit::schnorr_air::{
        self, SchnorrVerificationWitness, check_trace_constraints, generate_schnorr_trace,
        recompute_challenge,
    };
    use pyana_circuit::schnorr_sig::{schnorr_keygen, schnorr_sign};
