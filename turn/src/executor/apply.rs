//! Effect application: the giant `apply_effect` dispatch plus delegation/cross-cell access helpers.
//!
//! Extracted from `executor/mod.rs` (lines 6150-9565 of pre-decomposition file).
