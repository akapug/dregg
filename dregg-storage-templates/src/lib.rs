...
//! [`dregg_app_framework::FactoryDescriptor`]s with operation-scoped
...
//! operator-side primitives in `dregg_storage::{programmable, inbox,
...
//! [`TurnReceipt`]: dregg_app_framework
...
use dregg_app_framework::FactoryDescriptor;
...
/// field element (big-endian convention used across dregg cell state).
