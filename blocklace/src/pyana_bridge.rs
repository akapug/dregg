//! Bridge between the blocklace data structure and pyana's turn execution model.
//!
//! This module classifies turns into execution tiers and processes finalized blocks
//! into turn receipts that the pyana executor can apply.
...
/// Bridge between the blocklace consensus layer and pyana's turn executor.
///
/// Responsibilities:
...
pub struct PyanaBlocklaceBridge {
