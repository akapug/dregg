//! Dregg subsystem expressed in DSL form.
//!
//! This module defines dregg's 16 caveats and core effects using the
//! `#[dregg_caveat]` and `#[dregg_effect]` macros. These run ALONGSIDE
//! (not replacing) the hand-written code in `token::dregg_caveats`.
//!
...
#[dregg_effect(requires = "SetState")]
