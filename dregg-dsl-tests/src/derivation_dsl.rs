...
pub fn derivation_circuit_descriptor() -> CircuitDescriptor {
    ...
    CircuitDescriptor {
        name: "dregg-derivation-dsl-v1".into(),
...
mod tests {
    use super::*;
    use dregg_circuit::constraint_prover::Air;
    use dregg_circuit::derivation_air::{DerivationAir, DerivationWitness, create_test_derivation};
    ...
    fn dsl_circuit_rejects_fake_eq_check_terms() {
        ...
        use dregg_circuit::derivation_air::{BodyAtomPattern, CircuitEqualCheck, CircuitRule};
    ...
    fn dsl_circuit_rejects_fake_gte_terms() {
        ...
        use dregg_circuit::derivation_air::{BodyAtomPattern, CircuitGteCheck, CircuitRule};
        use dregg_circuit::poseidon2::hash_fact;
