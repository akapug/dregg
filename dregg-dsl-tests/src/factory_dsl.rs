...
impl StarkAir for FactoryVkDerivationAir {
    ...
    fn air_name(&self) -> &'static str {
        "dregg-factory-vk-derivation-v1"
    }
...
pub fn compute_set_root(approved_vks: &[[u8; 32]]) -> (u32, u32) {
    ...
    let root = dregg_circuit::poseidon2::hash_many(&elements);
...
mod tests {
    ...
    fn test_factory_air_properties() {
        ...
        assert_eq!(air.air_name(), "dregg-factory-creation-v1");
    }
    ...
    fn test_vk_derivation_air_properties() {
        ...
        assert_eq!(air.constraint_degree(), 2);
        assert_eq!(air.air_name(), "dregg-factory-vk-derivation-v1");
    }
    ...
    fn test_from_set_air_properties() {
        ...
        assert_eq!(air.constraint_degree(), 2);
        assert_eq!(air.air_name(), "dregg-factory-vk-from-set-v1");
    }
