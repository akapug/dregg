...
use dregg_circuit::derivation_air::{MAX_BODY_ATOMS, col as dcol};
use dregg_circuit::dsl::derivation::multi_col;
use dregg_circuit::field::{BABYBEAR_P, BabyBear};
use dregg_circuit::multi_step_air::{self, ALLOW_PREDICATE, MULTI_STEP_AIR_WIDTH, col, pi};
...
pub fn multi_step_circuit_descriptor() -> CircuitDescriptor {
    ...
    CircuitDescriptor {
        name: "dregg-multi-step-dsl-v1".into(),
