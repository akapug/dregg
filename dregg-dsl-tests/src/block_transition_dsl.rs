...
use dregg_circuit::block_transition_air::{BLOCK_TRANSITION_WIDTH, col};
...
pub fn block_transition_circuit_descriptor() -> CircuitDescriptor {
    ...
    CircuitDescriptor {
        name: "dregg-block-transition-dsl-v1".into(),
...
mod tests {
    ...
    fn descriptor_has_correct_structure() {
        ...
        assert_eq!(desc.name, "dregg-block-transition-dsl-v1");
