...
//! # Background
//!
//! Our dregg STARK proofs use FRI (Fast Reed-Solomon Interactive Oracle Proof) with:
...
pub fn fri_query_verifier_descriptor() -> CircuitDescriptor {
    ...
    CircuitDescriptor {
        name: "dregg-fri-query-verifier-v1".into(),
...
mod tests {
    ...
    fn test_fri_verifier_descriptor_structure() {
        ...
        assert_eq!(desc.name, "dregg-fri-query-verifier-v1");
    ...
    fn test_dsl_circuit_construction() {
        ...
        assert_eq!(circuit.air_name(), "dregg-fri-query-verifier-v1");
    }
}
