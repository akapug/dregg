...
theorem sealChainA_iff_spec (st : RecChainedState) (pid : Nat) (actor : CellId) (payload : Cap)
  ...
  · rw [if_pos hg]
    ...
    · rintro ⟨_, hsb, hlog, hacc, hcell, hcaps, hnull, hrev, hcom, hbal, hsw, hsc, hfac,
...
theorem unsealChainA_iff_spec (st : RecChainedState) (pid : Nat) (actor recipient : CellId)
  ...
  · rw [if_pos hg, hbox]
    ...
    · intro h
      ...
      refine ⟨⟨hg, rfl⟩, (grantedCaps_eq_grant _ _ _).symm, rfl, rfl, rfl, rfl, rfl, rfl, rfl,
             rfl, rfl, rfl, rfl, rfl, rfl, rfl, rfl, rfl, rfl⟩
    · rintro ⟨⟨_, _⟩, hcaps, hlog, hacc, hcell, hnull, hrev, hcom, hbal, hsw, hsc, hfac,
...
theorem unseal_preserves_box_store (st : RecChainedState) (pid : Nat) (actor recipient : CellId)
  ...
  obtain ⟨_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, hsb, _, _⟩ := h
  exact hsb
