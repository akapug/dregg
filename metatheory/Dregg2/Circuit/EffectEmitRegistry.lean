...
def actionAirName : FullActionA → String
  ...
  | .queueEnqueueA _ _ _ _ => Dregg2.Circuit.Inst.QueueEnqueueA.queueEnqueueAAirName
  | .queueDequeueA _ _ _ => Dregg2.Circuit.Inst.QueueDequeueA.queueDequeueAAirName
