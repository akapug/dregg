...
(`rotateV3`), so the soundness keystones lift ONCE, for all 26, not per-descriptor:
  ...
  * **§1 the appended geometry** — each rotated descriptor carries, PAST its v1 layout
    ...
    `perms_digest` + `vk_digest` + `mode` + `fields_root` limbs), a rotated AFTER block at `d.traceWidth + 151`, and the
    WIDENED-CAVEAT region at `d.traceWidth + 302` (29-felt manifest · 9 chain carriers · caveat
...
-- v11 accumulator-8-felt grow: the rotated appendix is 86 sites (was 70); the `rfl` reductions
...
/-- The per-block span: 112 pre-iroot limbs + iroot + state_commit + 37 chain carriers (v12:
NUM_PRE_LIMBS 88→112 — the carrier-material geometry grow appends three ZEROED 8-felt octets at
offsets 88..111 (child_vk8→88..95 · contract_hash8→96..103 · pubkey8→104..111), the committed homes the
per-carrier third-edge gates (factory · hatchery-contract · sovereign · membership) will FILL in a later
phase. Inert-zero here; absorbed generically by the `wireCommitR` chain (no new keystone). This rides
on the v11 accumulator-8-felt completion limbs 67..87 (nullifier→67..73 · commitments→74..80 · cells→81..87). -/
def B_SPAN : Nat := 151
...
#guard B_IROOT == 112                 -- 112 pre-iroot limbs (v12), then iroot
...
def preLimbsAt (base : Nat) (a : Assignment) : List ℤ :=
  ...
  , a (base + 108), a (base + 109), a (base + 110), a (base + 111) ]

theorem preLimbsAt_length (base : Nat) (a : Assignment) :
    (preLimbsAt base a).length = 112 := rfl
...
/-- The 38 chained absorption sites of a rotated block at `base` (v12): the 4-wide head, THIRTY-SIX
3-wide body groups (limbs 4..111 — the 108-limb body `[4..111]` is exactly thirty-six 3-wide groups, NO
...
position-independent. Chain carriers ride `base + 114 .. base + 150` (37 carriers); the state-commit
carrier is `base + 113`. -/
def rotV3SitesAt (base : Nat) : List VmHashSite :=
  [ ⟨base + 114, [.col (base + 0), .col (base + 1), .col (base + 2), .col (base + 3)], 4⟩
  , ⟨base + 115, [.col (base + 114), .col (base + 4), .col (base + 5), .col (base + 6)], 4⟩
  , ⟨base + 116, [.col (base + 115), .col (base + 7), .col (base + 8), .col (base + 9)], 4⟩
  , ⟨base + 117, [.col (base + 116), .col (base + 10), .col (base + 11), .col (base + 12)], 4⟩
  , ⟨base + 118, [.col (base + 117), .col (base + 13), .col (base + 14), .col (base + 15)], 4⟩
  , ⟨base + 119, [.col (base + 118), .col (base + 16), .col (base + 17), .col (base + 18)], 4⟩
  , ⟨base + 120, [.col (base + 119), .col (base + 19), .col (base + 20), .col (base + 21)], 4⟩
  , ⟨base + 121, [.col (base + 120), .col (base + 22), .col (base + 23), .col (base + 24)], 4⟩
  , ⟨base + 122, [.col (base + 121), .col (base + 25), .col (base + 26), .col (base + 27)], 4⟩
  , ⟨base + 123, [.col (base + 122), .col (base + 28), .col (base + 29), .col (base + 30)], 4⟩
  , ⟨base + 124, [.col (base + 123), .col (base + 31), .col (base + 32), .col (base + 33)], 4⟩
  , ⟨base + 125, [.col (base + 124), .col (base + 34), .col (base + 35), .col (base + 36)], 4⟩
  , ⟨base + 126, [.col (base + 125), .col (base + 37), .col (base + 38), .col (base + 39)], 4⟩
  , ⟨base + 127, [.col (base + 126), .col (base + 40), .col (base + 41), .col (base + 42)], 4⟩
  , ⟨base + 128, [.col (base + 127), .col (base + 43), .col (base + 44), .col (base + 45)], 4⟩
  , ⟨base + 129, [.col (base + 128), .col (base + 46), .col (base + 47), .col (base + 48)], 4⟩
  , ⟨base + 130, [.col (base + 129), .col (base + 49), .col (base + 50), .col (base + 51)], 4⟩
  , ⟨base + 131, [.col (base + 130), .col (base + 52), .col (base + 53), .col (base + 54)], 4⟩
  , ⟨base + 132, [.col (base + 131), .col (base + 55), .col (base + 56), .col (base + 57)], 4⟩
  , ⟨base + 133, [.col (base + 132), .col (base + 58), .col (base + 59), .col (base + 60)], 4⟩
  , ⟨base + 134, [.col (base + 133), .col (base + 61), .col (base + 62), .col (base + 63)], 4⟩
  , ⟨base + 135, [.col (base + 134), .col (base + 64), .col (base + 65), .col (base + 66)], 4⟩
  , ⟨base + 136, [.col (base + 135), .col (base + 67), .col (base + 68), .col (base + 69)], 4⟩
  , ⟨base + 137, [.col (base + 136), .col (base + 70), .col (base + 71), .col (base + 72)], 4⟩
  , ⟨base + 138, [.col (base + 137), .col (base + 73), .col (base + 74), .col (base + 75)], 4⟩
  , ⟨base + 139, [.col (base + 138), .col (base + 76), .col (base + 77), .col (base + 78)], 4⟩
  , ⟨base + 140, [.col (base + 139), .col (base + 79), .col (base + 80), .col (base + 81)], 4⟩
  , ⟨base + 141, [.col (base + 140), .col (base + 82), .col (base + 83), .col (base + 84)], 4⟩
  , ⟨base + 142, [.col (base + 141), .col (base + 85), .col (base + 86), .col (base + 87)], 4⟩
  , ⟨base + 143, [.col (base + 142), .col (base + 88), .col (base + 89), .col (base + 90)], 4⟩
  , ⟨base + 144, [.col (base + 143), .col (base + 91), .col (base + 92), .col (base + 93)], 4⟩
  , ⟨base + 145, [.col (base + 144), .col (base + 94), .col (base + 95), .col (base + 96)], 4⟩
  , ⟨base + 146, [.col (base + 145), .col (base + 97), .col (base + 98), .col (base + 99)], 4⟩
  , ⟨base + 147, [.col (base + 146), .col (base + 100), .col (base + 101), .col (base + 102)], 4⟩
  , ⟨base + 148, [.col (base + 147), .col (base + 103), .col (base + 104), .col (base + 105)], 4⟩
  , ⟨base + 149, [.col (base + 148), .col (base + 106), .col (base + 107), .col (base + 108)], 4⟩
  , ⟨base + 150, [.col (base + 149), .col (base + 109), .col (base + 110), .col (base + 111)], 4⟩
  , ⟨base + 113, [.col (base + 150), .col (base + 112)], 2⟩ ]
...
`w + B_SPAN` (= `w + 151`); the caveat region at `w + 2·B_SPAN` (= `w + 302`). -/
def rotV3Appendix (w : Nat) : List VmHashSite :=
  rotV3SitesAt w ++ rotV3SitesAt (w + 151) ++ caveatV3SitesAt (w + 302)
...
#guard (rotV3Appendix 186).length == 86   -- 38 (before) + 38 (after) + 10 (caveat)
...
private def rotV3SitesDigestAt0 : List VmHashSite :=
  [ ⟨114, [.col 0, .col 1, .col 2, .col 3], 4⟩
  , ⟨115, [.digest 0, .col 4, .col 5, .col 6], 4⟩
  , ⟨116, [.digest 1, .col 7, .col 8, .col 9], 4⟩
  , ⟨117, [.digest 2, .col 10, .col 11, .col 12], 4⟩
  , ⟨118, [.digest 3, .col 13, .col 14, .col 15], 4⟩
  , ⟨119, [.digest 4, .col 16, .col 17, .col 18], 4⟩
  , ⟨120, [.digest 5, .col 19, .col 20, .col 21], 4⟩
  , ⟨121, [.digest 6, .col 22, .col 23, .col 24], 4⟩
  , ⟨122, [.digest 7, .col 25, .col 26, .col 27], 4⟩
  , ⟨123, [.digest 8, .col 28, .col 29, .col 30], 4⟩
  , ⟨124, [.digest 9, .col 31, .col 32, .col 33], 4⟩
  , ⟨125, [.digest 10, .col 34, .col 35, .col 36], 4⟩
  , ⟨126, [.digest 11, .col 37, .col 38, .col 39], 4⟩
  , ⟨127, [.digest 12, .col 40, .col 41, .col 42], 4⟩
  , ⟨128, [.digest 13, .col 43, .col 44, .col 45], 4⟩
  , ⟨129, [.digest 14, .col 46, .col 47, .col 48], 4⟩
  , ⟨130, [.digest 15, .col 49, .col 50, .col 51], 4⟩
  , ⟨131, [.digest 16, .col 52, .col 53, .col 54], 4⟩
  , ⟨132, [.digest 17, .col 55, .col 56, .col 57], 4⟩
  , ⟨133, [.digest 18, .col 58, .col 59, .col 60], 4⟩
  , ⟨134, [.digest 19, .col 61, .col 62, .col 63], 4⟩
  , ⟨135, [.digest 20, .col 64, .col 65, .col 66], 4⟩
  , ⟨136, [.digest 21, .col 67, .col 68, .col 69], 4⟩
  , ⟨137, [.digest 22, .col 70, .col 71, .col 72], 4⟩
  , ⟨138, [.digest 23, .col 73, .col 74, .col 75], 4⟩
  , ⟨139, [.digest 24, .col 76, .col 77, .col 78], 4⟩
  , ⟨140, [.digest 25, .col 79, .col 80, .col 81], 4⟩
  , ⟨141, [.digest 26, .col 82, .col 83, .col 84], 4⟩
  , ⟨142, [.digest 27, .col 85, .col 86, .col 87], 4⟩
  , ⟨143, [.digest 28, .col 88, .col 89, .col 90], 4⟩
  , ⟨144, [.digest 29, .col 91, .col 92, .col 93], 4⟩
  , ⟨145, [.digest 30, .col 94, .col 95, .col 96], 4⟩
  , ⟨146, [.digest 31, .col 97, .col 98, .col 99], 4⟩
  , ⟨147, [.digest 32, .col 100, .col 101, .col 102], 4⟩
  , ⟨148, [.digest 33, .col 103, .col 104, .col 105], 4⟩
  , ⟨149, [.digest 34, .col 106, .col 107, .col 108], 4⟩
  , ⟨150, [.digest 35, .col 109, .col 110, .col 111], 4⟩
  , ⟨113, [.digest 36, .col 112], 2⟩ ]
...
def rotPins (w piBase : Nat) : List VmConstraint :=
  ...
  , .piBinding .last (w + 151 + B_STATE_COMMIT) (piBase + 1)
  , .piBinding .last (w + 151 + B_COMMITTED_HEIGHT) (piBase + 2)
  , .piBinding .last (w + 302 + C_COMMIT) (piBase + 3) ]
...
def rotateV3 (d : EffectVmDescriptor) : EffectVmDescriptor :=
  ...
  , constraints := d.constraints
      ++ (weldsAt d.traceWidth STATE_BEFORE_BASE
          ++ weldsAt (d.traceWidth + 151) STATE_AFTER_BASE
...
def rotateV3CapWrite (d : EffectVmDescriptor) : EffectVmDescriptor :=
  ...
  , constraints := d.constraints
      ++ (weldsAtNoCapRoot d.traceWidth STATE_BEFORE_BASE
          ++ weldsAtNoCapRoot (d.traceWidth + 151) STATE_AFTER_BASE
          ++ rotPins d.traceWidth d.piCount)
  , hashSites   := d.hashSites ++ rotV3Appendix d.traceWidth
  , ranges      := d.ranges }
...
theorem rotV3SitesAt_colOnly (base : Nat) : ∀ s ∈ rotV3SitesAt base, colOnly s = true := by
  ...
  rcases hs with rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl <;> rfl
...
into the chained rotated commitment — the row's state-commit carrier at `base + 113` IS
...
theorem rotV3SitesAt_pin (hash : List ℤ → ℤ) (env : VmRowEnv) (base : Nat)
    ...
    env.loc (base + 113)
      = wireCommitR hash (preLimbsAt base env.loc) (env.loc (base + 112)) := by
  have h0 : env.loc (base + 114) = hash [env.loc (base + 0), env.loc (base + 1),
      env.loc (base + 2), env.loc (base + 3)] := by
    simpa [VmHashSite.resolvedInputs, HashInput.resolve] using
      h ⟨base + 114, [.col (base + 0), .col (base + 1), .col (base + 2), .col (base + 3)], 4⟩
        (by simp [rotV3SitesAt])
  have h1 : env.loc (base + 115) = hash [env.loc (base + 114), env.loc (base + 4),
      env.loc (base + 5), env.loc (base + 6)] := by
    simpa [VmHashSite.resolvedInputs, HashInput.resolve] using
      h ⟨base + 115, [.col (base + 114), .col (base + 4), .col (base + 5),
        .col (base + 6)], 4⟩ (by simp [rotV3SitesAt])
  have h2 : env.loc (base + 116) = hash [env.loc (base + 115), env.loc (base + 7),
      env.loc (base + 8), env.loc (base + 9)] := by
    simpa [VmHashSite.resolvedInputs, HashInput.resolve] using
      h ⟨base + 116, [.col (base + 115), .col (base + 7), .col (base + 8),
        .col (base + 9)], 4⟩ (by simp [rotV3SitesAt])
  have h3 : env.loc (base + 117) = hash [env.loc (base + 116), env.loc (base + 10),
      env.loc (base + 11), env.loc (base + 12)] := by
    simpa [VmHashSite.resolvedInputs, HashInput.resolve] using
      h ⟨base + 117, [.col (base + 116), .col (base + 10), .col (base + 11),
        .col (base + 12)], 4⟩ (by simp [rotV3SitesAt])
  have h4 : env.loc (base + 118) = hash [env.loc (base + 117), env.loc (base + 13),
      env.loc (base + 14), env.loc (base + 15)] := by
    simpa [VmHashSite.resolvedInputs, HashInput.resolve] using
      h ⟨base + 118, [.col (base + 117), .col (base + 13), .col (base + 14),
        .col (base + 15)], 4⟩ (by simp [rotV3SitesAt])
  have h5 : env.loc (base + 119) = hash [env.loc (base + 118), env.loc (base + 16),
      env.loc (base + 17), env.loc (base + 18)] := by
    simpa [VmHashSite.resolvedInputs, HashInput.resolve] using
      h ⟨base + 119, [.col (base + 118), .col (base + 16), .col (base + 17),
        .col (base + 18)], 4⟩ (by simp [rotV3SitesAt])
  have h6 : env.loc (base + 120) = hash [env.loc (base + 119), env.loc (base + 19),
      env.loc (base + 20), env.loc (base + 21)] := by
    simpa [VmHashSite.resolvedInputs, HashInput.resolve] using
      h ⟨base + 120, [.col (base + 119), .col (base + 19), .col (base + 20),
        .col (base + 21)], 4⟩ (by simp [rotV3SitesAt])
  have h7 : env.loc (base + 121) = hash [env.loc (base + 120), env.loc (base + 22),
      env.loc (base + 23), env.loc (base + 24)] := by
    simpa [VmHashSite.resolvedInputs, HashInput.resolve] using
      h ⟨base + 121, [.col (base + 120), .col (base + 22), .col (base + 23),
        .col (base + 24)], 4⟩ (by simp [rotV3SitesAt])
  have h8 : env.loc (base + 122) = hash [env.loc (base + 121), env.loc (base + 25),
      env.loc (base + 26), env.loc (base + 27)] := by
    simpa [VmHashSite.resolvedInputs, HashInput.resolve] using
      h ⟨base + 122, [.col (base + 121), .col (base + 25), .col (base + 26),
        .col (base + 27)], 4⟩ (by simp [rotV3SitesAt])
  have h9 : env.loc (base + 123) = hash [env.loc (base + 122), env.loc (base + 28),
      env.loc (base + 29), env.loc (base + 30)] := by
    simpa [VmHashSite.resolvedInputs, HashInput.resolve] using
      h ⟨base + 123, [.col (base + 122), .col (base + 28), .col (base + 29),
        .col (base + 30)], 4⟩ (by simp [rotV3SitesAt])
  have h10 : env.loc (base + 124) = hash [env.loc (base + 123), env.loc (base + 31),
      env.loc (base + 32), env.loc (base + 33)] := by
    simpa [VmHashSite.resolvedInputs, HashInput.resolve] using
      h ⟨base + 124, [.col (base + 123), .col (base + 31), .col (base + 32),
        .col (base + 33)], 4⟩ (by simp [rotV3SitesAt])
  have h11 : env.loc (base + 125) = hash [env.loc (base + 124), env.loc (base + 34),
      env.loc (base + 35), env.loc (base + 36)] := by
    simpa [VmHashSite.resolvedInputs, HashInput.resolve] using
      h ⟨base + 125, [.col (base + 124), .col (base + 34), .col (base + 35),
        .col (base + 36)], 4⟩ (by simp [rotV3SitesAt])
  have h12 : env.loc (base + 126) = hash [env.loc (base + 125), env.loc (base + 37),
      env.loc (base + 38), env.loc (base + 39)] := by
    simpa [VmHashSite.resolvedInputs, HashInput.resolve] using
      h ⟨base + 126, [.col (base + 125), .col (base + 37), .col (base + 38),
        .col (base + 39)], 4⟩ (by simp [rotV3SitesAt])
  have h13 : env.loc (base + 127) = hash [env.loc (base + 126), env.loc (base + 40),
      env.loc (base + 41), env.loc (base + 42)] := by
    simpa [VmHashSite.resolvedInputs, HashInput.resolve] using
      h ⟨base + 127, [.col (base + 126), .col (base + 40), .col (base + 41),
        .col (base + 42)], 4⟩ (by simp [rotV3SitesAt])
  have h14 : env.loc (base + 128) = hash [env.loc (base + 127), env.loc (base + 43),
      env.loc (base + 44), env.loc (base + 45)] := by
    simpa [VmHashSite.resolvedInputs, HashInput.resolve] using
      h ⟨base + 128, [.col (base + 127), .col (base + 43), .col (base + 44),
        .col (base + 45)], 4⟩ (by simp [rotV3SitesAt])
  have h15 : env.loc (base + 129) = hash [env.loc (base + 128), env.loc (base + 46),
      env.loc (base + 47), env.loc (base + 48)] := by
    simpa [VmHashSite.resolvedInputs, HashInput.resolve] using
      h ⟨base + 129, [.col (base + 128), .col (base + 46), .col (base + 47),
        .col (base + 48)], 4⟩ (by simp [rotV3SitesAt])
  have h16 : env.loc (base + 130) = hash [env.loc (base + 129), env.loc (base + 49),
      env.loc (base + 50), env.loc (base + 51)] := by
    simpa [VmHashSite.resolvedInputs, HashInput.resolve] using
      h ⟨base + 130, [.col (base + 129), .col (base + 49), .col (base + 50),
        .col (base + 51)], 4⟩ (by simp [rotV3SitesAt])
  have h17 : env.loc (base + 131) = hash [env.loc (base + 130), env.loc (base + 52),
      env.loc (base + 53), env.loc (base + 54)] := by
    simpa [VmHashSite.resolvedInputs, HashInput.resolve] using
      h ⟨base + 131, [.col (base + 130), .col (base + 52), .col (base + 53),
        .col (base + 54)], 4⟩ (by simp [rotV3SitesAt])
  have h18 : env.loc (base + 132) = hash [env.loc (base + 131), env.loc (base + 55),
      env.loc (base + 56), env.loc (base + 57)] := by
    simpa [VmHashSite.resolvedInputs, HashInput.resolve] using
      h ⟨base + 132, [.col (base + 131), .col (base + 55), .col (base + 56),
        .col (base + 57)], 4⟩ (by simp [rotV3SitesAt])
  have h19 : env.loc (base + 133) = hash [env.loc (base + 132), env.loc (base + 58),
      env.loc (base + 59), env.loc (base + 60)] := by
    simpa [VmHashSite.resolvedInputs, HashInput.resolve] using
      h ⟨base + 133, [.col (base + 132), .col (base + 58), .col (base + 59),
        .col (base + 60)], 4⟩ (by simp [rotV3SitesAt])
  have h20 : env.loc (base + 134) = hash [env.loc (base + 133), env.loc (base + 61),
      env.loc (base + 62), env.loc (base + 63)] := by
    simpa [VmHashSite.resolvedInputs, HashInput.resolve] using
      h ⟨base + 134, [.col (base + 133), .col (base + 61), .col (base + 62),
        .col (base + 63)], 4⟩ (by simp [rotV3SitesAt])
  have h21 : env.loc (base + 135) = hash [env.loc (base + 134), env.loc (base + 64),
      env.loc (base + 65), env.loc (base + 66)] := by
    simpa [VmHashSite.resolvedInputs, HashInput.resolve] using
      h ⟨base + 135, [.col (base + 134), .col (base + 64), .col (base + 65),
        .col (base + 66)], 4⟩ (by simp [rotV3SitesAt])
  have h22 : env.loc (base + 136) = hash [env.loc (base + 135), env.loc (base + 67),
      env.loc (base + 68), env.loc (base + 69)] := by
    simpa [VmHashSite.resolvedInputs, HashInput.resolve] using
      h ⟨base + 136, [.col (base + 135), .col (base + 67), .col (base + 68),
        .col (base + 69)], 4⟩ (by simp [rotV3SitesAt])
  have h23 : env.loc (base + 137) = hash [env.loc (base + 136), env.loc (base + 70),
      env.loc (base + 71), env.loc (base + 72)] := by
    simpa [VmHashSite.resolvedInputs, HashInput.resolve] using
      h ⟨base + 137, [.col (base + 136), .col (base + 70), .col (base + 71),
        .col (base + 72)], 4⟩ (by simp [rotV3SitesAt])
  have h24 : env.loc (base + 138) = hash [env.loc (base + 137), env.loc (base + 73),
      env.loc (base + 74), env.loc (base + 75)] := by
    simpa [VmHashSite.resolvedInputs, HashInput.resolve] using
      h ⟨base + 138, [.col (base + 137), .col (base + 73), .col (base + 74),
        .col (base + 75)], 4⟩ (by simp [rotV3SitesAt])
  have h25 : env.loc (base + 139) = hash [env.loc (base + 138), env.loc (base + 76),
      env.loc (base + 77), env.loc (base + 78)] := by
    simpa [VmHashSite.resolvedInputs, HashInput.resolve] using
      h ⟨base + 139, [.col (base + 138), .col (base + 76), .col (base + 77),
        .col (base + 78)], 4⟩ (by simp [rotV3SitesAt])
  have h26 : env.loc (base + 140) = hash [env.loc (base + 139), env.loc (base + 79),
      env.loc (base + 80), env.loc (base + 81)] := by
    simpa [VmHashSite.resolvedInputs, HashInput.resolve] using
      h ⟨base + 140, [.col (base + 139), .col (base + 79), .col (base + 80),
        .col (base + 81)], 4⟩ (by simp [rotV3SitesAt])
  have h27 : env.loc (base + 141) = hash [env.loc (base + 140), env.loc (base + 82),
      env.loc (base + 83), env.loc (base + 84)] := by
    simpa [VmHashSite.resolvedInputs, HashInput.resolve] using
      h ⟨base + 141, [.col (base + 140), .col (base + 82), .col (base + 83),
        .col (base + 84)], 4⟩ (by simp [rotV3SitesAt])
  have h28 : env.loc (base + 142) = hash [env.loc (base + 141), env.loc (base + 85),
      env.loc (base + 86), env.loc (base + 87)] := by
    simpa [VmHashSite.resolvedInputs, HashInput.resolve] using
      h ⟨base + 142, [.col (base + 141), .col (base + 85), .col (base + 86),
        .col (base + 87)], 4⟩ (by simp [rotV3SitesAt])
  have h29 : env.loc (base + 143) = hash [env.loc (base + 142), env.loc (base + 88),
      env.loc (base + 89), env.loc (base + 90)] := by
    simpa [VmHashSite.resolvedInputs, HashInput.resolve] using
      h ⟨base + 143, [.col (base + 142), .col (base + 88), .col (base + 89),
        .col (base + 90)], 4⟩ (by simp [rotV3SitesAt])
  have h30 : env.loc (base + 144) = hash [env.loc (base + 143), env.loc (base + 91),
      env.loc (base + 92), env.loc (base + 93)] := by
    simpa [VmHashSite.resolvedInputs, HashInput.resolve] using
      h ⟨base + 144, [.col (base + 143), .col (base + 91), .col (base + 92),
        .col (base + 93)], 4⟩ (by simp [rotV3SitesAt])
  have h31 : env.loc (base + 145) = hash [env.loc (base + 144), env.loc (base + 94),
      env.loc (base + 95), env.loc (base + 96)] := by
    simpa [VmHashSite.resolvedInputs, HashInput.resolve] using
      h ⟨base + 145, [.col (base + 144), .col (base + 94), .col (base + 95),
        .col (base + 96)], 4⟩ (by simp [rotV3SitesAt])
  have h32 : env.loc (base + 146) = hash [env.loc (base + 145), env.loc (base + 97),
      env.loc (base + 98), env.loc (base + 99)] := by
    simpa [VmHashSite.resolvedInputs, HashInput.resolve] using
      h ⟨base + 146, [.col (base + 145), .col (base + 97), .col (base + 98),
        .col (base + 99)], 4⟩ (by simp [rotV3SitesAt])
  have h33 : env.loc (base + 147) = hash [env.loc (base + 146), env.loc (base + 100),
      env.loc (base + 101), env.loc (base + 102)] := by
    simpa [VmHashSite.resolvedInputs, HashInput.resolve] using
      h ⟨base + 147, [.col (base + 146), .col (base + 100), .col (base + 101),
        .col (base + 102)], 4⟩ (by simp [rotV3SitesAt])
  have h34 : env.loc (base + 148) = hash [env.loc (base + 147), env.loc (base + 103),
      env.loc (base + 104), env.loc (base + 105)] := by
    simpa [VmHashSite.resolvedInputs, HashInput.resolve] using
      h ⟨base + 148, [.col (base + 147), .col (base + 103), .col (base + 104),
        .col (base + 105)], 4⟩ (by simp [rotV3SitesAt])
  have h35 : env.loc (base + 149) = hash [env.loc (base + 148), env.loc (base + 106),
      env.loc (base + 107), env.loc (base + 108)] := by
    simpa [VmHashSite.resolvedInputs, HashInput.resolve] using
      h ⟨base + 149, [.col (base + 148), .col (base + 106), .col (base + 107),
        .col (base + 108)], 4⟩ (by simp [rotV3SitesAt])
  have h36 : env.loc (base + 150) = hash [env.loc (base + 149), env.loc (base + 109),
      env.loc (base + 110), env.loc (base + 111)] := by
    simpa [VmHashSite.resolvedInputs, HashInput.resolve] using
      h ⟨base + 150, [.col (base + 149), .col (base + 109), .col (base + 110),
        .col (base + 111)], 4⟩ (by simp [rotV3SitesAt])
  have h37 : env.loc (base + 113) = hash [env.loc (base + 150), env.loc (base + 112)] := by
    simpa [VmHashSite.resolvedInputs, HashInput.resolve] using
      h ⟨base + 113, [.col (base + 150), .col (base + 112)], 2⟩ (by simp [rotV3SitesAt])
  rw [h37, h36, h35, h34, h33, h32, h31, h30, h29, h28, h27, h26, h25, h24, h23, h22, h21, h20, h19, h18, h17, h16, h15, h14, h13, h12, h11, h10, h9, h8, h7, h6, h5, h4, h3, h2, h1, h0]
  rfl
...
theorem rotateV3_pins_commits (hash : List ℤ → ℤ) (d : EffectVmDescriptor)
    (env : VmRowEnv) (isFirst isLast : Bool)
    (h : satisfiedVm hash (rotateV3 d) env isFirst isLast) :
    env.loc (d.traceWidth + 113)
      = wireCommitR hash (preLimbsAt d.traceWidth env.loc) (env.loc (d.traceWidth + 112))
    ∧ env.loc (d.traceWidth + 151 + 113)
      = wireCommitR hash (preLimbsAt (d.traceWidth + 151) env.loc)
          (env.loc (d.traceWidth + 151 + 112))
    ∧ env.loc (d.traceWidth + 302 + 38)
      = caveatCommit hash (manifestAt (d.traceWidth + 302) env.loc) := by
  have hsites := h.2.1
  ...
  · exact rotV3SitesAt_pin hash env (d.traceWidth + 151) fun s hs =>
      heq s (hmem s (List.mem_append_left _ (List.mem_append_right _ hs)))
        (rotV3SitesAt_colOnly _ s hs)
  · exact caveatV3SitesAt_pin hash env (d.traceWidth + 302) fun s hs =>
...
theorem rotateV3_weld (hash : List ℤ → ℤ) (d : EffectVmDescriptor)
    ...
    (hw : colEq a b ∈ weldsAt d.traceWidth STATE_BEFORE_BASE
        ∨ colEq a b ∈ weldsAt (d.traceWidth + 151) STATE_AFTER_BASE) :
...
theorem rotateV3_welds_named (hash : List ℤ → ℤ) (d : EffectVmDescriptor)
    ...
    ∧ env.loc (d.traceWidth + 151 + 1) = env.loc (saCol state.BALANCE_LO)
    ∧ env.loc (d.traceWidth + 151 + 2) = env.loc (saCol state.NONCE)
    ∧ env.loc (d.traceWidth + 151 + B_CAP_ROOT) = env.loc (saCol state.CAP_ROOT) := by
  refine ⟨?_, ?_, ?_, ?_, ?_, ?_⟩
...
theorem rotV3_pins (permOut : List ℤ → List ℤ) (hash : List ℤ → ℤ) (d : EffectVmDescriptor)
    ...
    (envAt t i).loc (d.traceWidth + 113)
      = wireCommitR hash (preLimbsAt d.traceWidth (envAt t i).loc)
          ((envAt t i).loc (d.traceWidth + 112))
    ∧ (envAt t i).loc (d.traceWidth + 151 + 113)
      = wireCommitR hash (preLimbsAt (d.traceWidth + 151) (envAt t i).loc)
          ((envAt t i).loc (d.traceWidth + 151 + 112))
    ∧ (envAt t i).loc (d.traceWidth + 302 + 38)
      = caveatCommit hash (manifestAt (d.traceWidth + 302) (envAt t i).loc) :=
...
theorem rotV3_publishes (permOut : List ℤ → List ℤ) (hash : List ℤ → ℤ) (d : EffectVmDescriptor)
    ...
    ∧ ((i + 1 == t.rows.length) = true →
      (envAt t i).loc (d.traceWidth + 151 + B_STATE_COMMIT) = (envAt t i).pub (d.piCount + 1)
      ∧ (envAt t i).loc (d.traceWidth + 151 + B_COMMITTED_HEIGHT)
          = (envAt t i).pub (d.piCount + 2)
      ∧ (envAt t i).loc (d.traceWidth + 302 + C_COMMIT) = (envAt t i).pub (d.piCount + 3)) := by
  ...
  have h0 := h.1 _ (hmem (.piBinding .first (d.traceWidth + B_STATE_COMMIT) d.piCount)
    (by simp [rotPins]))
  have h1 := h.1 _ (hmem (.piBinding .last (d.traceWidth + 151 + B_STATE_COMMIT)
    (d.piCount + 1)) (by simp [rotPins]))
  have h2 := h.1 _ (hmem (.piBinding .last (d.traceWidth + 151 + B_COMMITTED_HEIGHT)
    (d.piCount + 2)) (by simp [rotPins]))
  have h3 := h.1 _ (hmem (.piBinding .last (d.traceWidth + 302 + C_COMMIT) (d.piCount + 3))
    (by simp [rotPins]))
...
theorem rotV3_binds_published (permOut : List ℤ → List ℤ) (hash : List ℤ → ℤ)
    ...
    (preLimbsAt d.traceWidth (envAt t i).loc = preLimbsAt d.traceWidth (envAt t' j).loc
      ∧ (envAt t i).loc (d.traceWidth + 112) = (envAt t' j).loc (d.traceWidth + 112))
    ∧ (preLimbsAt (d.traceWidth + 151) (envAt t k).loc
        = preLimbsAt (d.traceWidth + 151) (envAt t' l).loc
      ∧ (envAt t k).loc (d.traceWidth + 151 + 112) = (envAt t' l).loc (d.traceWidth + 151 + 112)
      ∧ (envAt t k).pub (d.piCount + 2) = (envAt t' l).pub (d.piCount + 2))
    ∧ manifestAt (d.traceWidth + 302) (envAt t k).loc
        = manifestAt (d.traceWidth + 302) (envAt t' l).loc := by
  ...
  · -- the before block, via the first-row pins
    ...
    have hwire : wireCommitR hash (preLimbsAt d.traceWidth (envAt t i).loc)
        ...
        = wireCommitR hash (preLimbsAt d.traceWidth (envAt t' j).loc)
            ((envAt t' j).loc (d.traceWidth + 112)) := by
  ...
  · -- the after block, via the last-row pins
    ...
    have hwire : wireCommitR hash (preLimbsAt (d.traceWidth + 151) (envAt t k).loc)
        ((envAt t k).loc (d.traceWidth + 151 + 112))
        = wireCommitR hash (preLimbsAt (d.traceWidth + 151) (envAt t' l).loc)
            ((envAt t' l).loc (d.traceWidth + 151 + 112)) := by
      rw [← (hp k hk).2.1, ← (hp' l hl).2.1]
      show (envAt t k).loc (d.traceWidth + 151 + B_STATE_COMMIT)
        = (envAt t' l).loc (d.traceWidth + 151 + B_STATE_COMMIT)
      rw [hc, hc', hpubNew]
  ...
  · -- the caveat manifest, via the last-row pin
    ...
    have hcc : caveatCommit hash (manifestAt (d.traceWidth + 302) (envAt t k).loc)
        = caveatCommit hash (manifestAt (d.traceWidth + 302) (envAt t' l).loc) := by
      rw [← (hp k hk).2.2, ← (hp' l hl).2.2]
      show (envAt t k).loc (d.traceWidth + 302 + C_COMMIT)
        = (envAt t' l).loc (d.traceWidth + 302 + C_COMMIT)
      rw [hk1, hk2, hpubCav]
...
/-- The rotated AFTER-block `cap_root` limb column (limb 25 of the after block at `base = w + 151`). The
deployed cap accumulator's POST root — the write-gate's `newRoot`, witness-carried (no v1-state continuity). -/
def afterCapRootCol (w : Nat) : Nat := w + 151 + B_CAP_ROOT
...
lane 0; the seven completion limbs 51..57 for lanes 1..7). `blockBase = w` (BEFORE) / `w + 151` (AFTER). -/
...
def afterCapRootCols (env : VmRowEnv) : Digest8 :=
  fun i => env.loc (capRootGroupCol (EFFECT_VM_WIDTH + 151) i)
...
def afterHeapRootCol (w : Nat) : Nat := w + 151 + B_HEAP_ROOT
...
def afterHeapRootCols (env : VmRowEnv) : Digest8 :=
  fun i => env.loc (heapRootGroupCol (EFFECT_VM_WIDTH + 151) i)
...
def afterCapRootGroup : Fin 8 → EmittedExpr := fun i => .var (capRootGroupCol (EFFECT_VM_WIDTH + 151) i)
...
def afterHeapRootGroup : Fin 8 → EmittedExpr := fun i => .var (heapRootGroupCol (EFFECT_VM_WIDTH + 151) i)
...
def afterFieldsRootCols (env : VmRowEnv) : Digest8 :=
  fun i => env.loc (fieldsRootGroupCol (EFFECT_VM_WIDTH + 151) i)
...
def afterFieldsRootGroup : Fin 8 → EmittedExpr := fun i => .var (fieldsRootGroupCol (EFFECT_VM_WIDTH + 151) i)
...
theorem afterFieldsRootCols_lane0 (env : VmRowEnv) :
    afterFieldsRootCols env 0 = env.loc (EFFECT_VM_WIDTH + 151 + B_FIELDS_ROOT) := by
...
def afterNullifierRootGroup : Fin 8 → EmittedExpr :=
  fun i => .var (nullifierRootGroupCol (EFFECT_VM_WIDTH + 151) i)
...
def afterCommitmentsRootGroup : Fin 8 → EmittedExpr :=
  fun i => .var (commitmentsRootGroupCol (EFFECT_VM_WIDTH + 151) i)
...
def afterCellsRootGroup : Fin 8 → EmittedExpr :=
  fun i => .var (cellsRootGroupCol (EFFECT_VM_WIDTH + 151) i)
...
def afterNullifierRootCols (env : VmRowEnv) : Digest8 :=
  fun i => env.loc (nullifierRootGroupCol (EFFECT_VM_WIDTH + 151) i)
...
def afterCommitmentsRootCols (env : VmRowEnv) : Digest8 :=
  fun i => env.loc (commitmentsRootGroupCol (EFFECT_VM_WIDTH + 151) i)
...
def afterCellsRootCols (env : VmRowEnv) : Digest8 :=
  fun i => env.loc (cellsRootGroupCol (EFFECT_VM_WIDTH + 151) i)
...
/-- The rotated AFTER-block `delegation_epoch` limb column (limb 30 of the after block at `base = w + 151`). -/
def afterEpochCol (w : Nat) : Nat := w + 151 + B_EPOCH
...
`base = traceWidth + 151`). The deployed nullifier accumulator's POST root — the grow-gate's
`newRoot`. -/
def afterNullifierRootCol (w : Nat) : Nat := w + 151 + 26
...
`base = traceWidth + 151`). The deployed commitments accumulator's POST root — the grow-gate's
`newRoot`. -/
def afterCommitmentsRootCol (w : Nat) : Nat := w + 151 + B_COMMITMENTS_ROOT
...
#guard afterCommitmentsRootCol EFFECT_VM_WIDTH == EFFECT_VM_WIDTH + 151 + 27
...
`base = traceWidth + 151`). The deployed accounts accumulator's POST root — the grow-gate's
`newRoot`. -/
def afterCellsRootCol (w : Nat) : Nat := w + 151 + 0
...
#guard afterFieldsRootCol EFFECT_VM_WIDTH == EFFECT_VM_WIDTH + 151 + 36
...
-- The mode / fields-root force-cols land at AFTER limb 35 / 36 (= traceWidth + 151 + 35 / +36).
#guard afterModeCol EFFECT_VM_WIDTH == EFFECT_VM_WIDTH + 151 + 35
#guard afterFieldsRootCol EFFECT_VM_WIDTH == EFFECT_VM_WIDTH + 151 + 36
...
-- The perms/vk force-cols land at AFTER limb 33 / 34 (= traceWidth + 151 + 33 / +34).
#guard afterPermsCol EFFECT_VM_WIDTH == EFFECT_VM_WIDTH + 151 + 33
#guard afterVKCol EFFECT_VM_WIDTH == EFFECT_VM_WIDTH + 151 + 34
...
-- The disc force-cols land at AFTER limb 32 (= traceWidth + 151 + 32) and BEFORE limb 32.
#guard afterDiscCol EFFECT_VM_WIDTH == EFFECT_VM_WIDTH + 151 + 32
...
#guard (let off := B_LIFECYCLE; let tw := (186 : Nat);
        let env : VmRowEnv := ⟨fun c => if c == tw + 151 + off then 1 else 0, fun _ => 0, fun k => if k == 46 then 1 else 0⟩;
        decide (env.loc (tw + 151 + off) = env.pub 46))   -- sealed (1) == PI[46] ⇒ pin holds
#guard (let off := B_LIFECYCLE; let tw := (186 : Nat);
...
#guard (v3Of EffectVmEmitTransfer.transferVmDescriptor).constraints.length
        == transferVmDescriptor2.constraints.length + 24 + 4 + 86
