...
cap-table digest ONLY as `Function.Injective D`. Imports read-only.
-/
...
#guard revokeVmDescriptor.traceWidth == 188
...
#guard revokeDelegationVmDescriptorWide.traceWidth == 190
