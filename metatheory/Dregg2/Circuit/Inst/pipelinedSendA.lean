...
theorem apex_iff_pipelinedSendSpec (s : RecChainedState) (args : PipelinedSendArgs)
  ...
  · -- kernelFrame order: accounts caps bal escrows nullifiers revoked commitments queues swiss …
    rintro ⟨_, hcell, hlog, hAcc, hCaps, hBal, hNul, hRev, hCom, hQ, hSC, hFac, hLif,
      hDC, hDel, hDgs, hSB⟩
    -- PipelinedSendSpec order: log accounts cell caps escrows nullifiers revoked commitments bal queues …
    exact ⟨hlog, hAcc, hcell, hCaps, hNul, hRev, hCom, hBal, hQ, hSC, hFac, hLif,
      hDC, hDel, hDgs, hSB⟩
  · rintro ⟨hlog, hAcc, hcell, hCaps, hNul, hRev, hCom, hBal, hQ, hSC, hFac, hLif,
      hDC, hDel, hDgs, hSB⟩
    exact ⟨trivial, hcell, hlog, hAcc, hCaps, hBal, hNul, hRev, hCom, hQ, hSC, hFac, hLif,
      hDC, hDel, hDgs, hSB⟩
