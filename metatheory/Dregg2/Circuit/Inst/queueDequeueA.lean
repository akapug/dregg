...
def queueDequeueEWire : EffectSpec2Triple RecChainedState DequeueArgs where
  view         := chainView
  active1      :=
...
def queueDequeueAEmitted : EmittedDescriptor := emittedEffect2Triple queueDequeueAAirName queueDequeueEWire
