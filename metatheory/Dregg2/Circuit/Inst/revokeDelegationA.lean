...
def revokeDelegationEWire : EffectSpec2 RecChainedState RevokeArgs where
  view         := chainView
  active      :=
...
def revokeDelegationAAirName : String := "dregg-revokeDelegationA-v2"

def revokeDelegationAEmitted : EmittedDescriptor := emittedEffect2 revokeDelegationAAirName revokeDelegationEWire

#guard revokeDelegationAEmitted.name == revokeDelegationAAirName
