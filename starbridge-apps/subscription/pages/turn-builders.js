...
// Slot indices + event topics come from the AUTOGENERATED constants module
// (rendered from src/lib.rs) so the JS cannot drift from the slot layout /
...
const TOPIC_PUBLISHED         = TOPICS.PUBLISHED;
const TOPIC_CONSUMED          = TOPICS.CONSUMED;
const TOPIC_PUBLISHER_GRANTED = TOPICS.PUBLISHER_GRANTED;
const TOPIC_CONSUMER_GRANTED  = TOPICS.CONSUMER_GRANTED;
