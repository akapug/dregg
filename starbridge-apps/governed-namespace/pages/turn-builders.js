...
// Slot indices, method names, and event topics come from the AUTOGENERATED
// constants module (rendered from src/lib.rs). This ALSO fixes a real drift
// bug: the old hand-written topics (`namespace-proposal-submitted`, ...) never
// matched the executor's actual events (`proposal-opened`, ...), so any
// inspector keyed to them missed every event. They now agree by construction.
import {
...
const TOPIC_PROPOSED      = TOPICS.PROPOSED;
const TOPIC_VOTED         = TOPICS.VOTED;
const TOPIC_COMMITTED     = TOPICS.COMMITTED;
const TOPIC_SERVICE_BOUND = TOPICS.SERVICE_BOUND;
