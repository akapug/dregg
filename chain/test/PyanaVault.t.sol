...
contract PyanaVaultTest is Test {
    PyanaVault public vault;
    ...
    function setUp() public {
        ...
        vault = new PyanaVault(address(verifier), PROGRAM_VKEY);
        token = new MockERC20();
    }
    ...
    function test_depositRevertsOnZeroAmount() public {
        ...
        vm.expectRevert(PyanaVault.ZeroAmount.selector);
    ...
    function test_depositRevertsDuplicateCommitment() public {
        ...
        vm.expectRevert(PyanaVault.DuplicateNoteCommitment.selector);
        vault.deposit(address(token), amount, commitment);
    }
    ...
    function test_doubleSpendRejected() public {
        ...
        vm.expectRevert(abi.encodeWithSelector(PyanaVault.NullifierAlreadyUsed.selector, nullifier));
        vault.withdraw(address(0), 0.5 ether, RECIPIENT, sp1Proof);
    }
    ...
    function test_invalidProofRejected() public {
        ...
        vm.expectRevert(PyanaVault.ProofVerificationFailed.selector);
        vault.withdraw(address(0), 0.5 ether, RECIPIENT, sp1Proof);
    }
    ...
    function test_frontrunningProtection_recipientMismatch() public {
        ...
        vm.expectRevert(PyanaVault.RecipientMismatch.selector);
    ...
    function test_frontrunningProtection_amountMismatch() public {
        ...
        vm.expectRevert(PyanaVault.AmountMismatch.selector);
    ...
    function test_frontrunningProtection_tokenMismatch() public {
        ...
        vm.expectRevert(PyanaVault.TokenMismatch.selector);
